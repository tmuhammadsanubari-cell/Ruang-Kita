...
import { LogOut, Menu, X, Bell, Loader2 } from 'lucide-react';
...
export function Navbar({ onNavigate, currentPage }: NavbarProps) {
  ...
  // State untuk konfirmasi logout dan loading
  ...
  const handleLogoutConfirm = async () => {
    try {
      ...
      // Simulasi loading sebentar (misal 1 detik) agar user melihat prosesnya
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-3">
                ...
                {/* Tombol Logout Desktop - Membuka Dialog */}
                <Button
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <div className="px-4 py-3 border-t border-slate-200 mt-2">
                ...
                {/* Tombol Logout Mobile - Membuka Dialog */}
                <Button 
                  onClick={() => {
                    setIsMobileMenuOpen(false);
      ...
      <AlertDialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Apakah Anda yakin ingin keluar dari akun ini? Anda harus login kembali untuk mengakses fitur aplikasi.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
